            ...
            <div className="w-96 h-[26rem] shadow-lg rounded-xl bg-slate-50 p-8">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col p-4">
                    ...
                    <div className="flex h-10 shadow px-2 rounded-lg my-6 focus-within:shadow-md">
                        ...
                        <input type="email" name="email" id="email" className="w-full px-2 outline-none" placeholder="Email" onChange={handleInputChange} value={formData.email} />
                    </div>

                    <div className="flex h-10 shadow px-2 rounded-lg my-6 focus-within:shadow-md">
                        <img className="w-8 h-8" src="/src/assets/lock.svg" alt="email icon" />
                        <input type="password" name="password" id="password" className="w-full px-2 outline-none" placeholder="Password" onChange={handleInputChange} value={formData.email} />
                    </div>
