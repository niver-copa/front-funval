      ...
      <Nav />
        <main className="container mx-auto py-8">
          <div className="flex justify-center">
            <div className="w-full md:w-1/2 p-4">
              ...
              <input
                id="search"
                type="text"
                className="w-full px-4 py-2 border border-blue-900 rounded-md"
              />
            </div>
            <button
          ...
          <div className="flex flex-col items-center">
            <h1 className="text-2xl mt-4">Nuestros Modelos</h1>
            <table className="w-full md:w-2/3 table-auto bg-white shadow-lg rounded-lg overflow-hidden mt-8">
              <thead className="bg-blue-900 text-white">
                <tr>
                  ...
                  <th className="py-4 px-6 text-start">Nombre del Modelo</th>
                </tr>
              </thead>
              <tbody>
                {modelos.map((modelos) => (
                  <tr key={modelos.id} className="border-b border-gray-300">
                    <td className="py-4 px-6">{modelos.id}</td>
                    <td className="py-4 px-6">{modelos.nombre}</td>
                  </tr>
                ))}
              </tbody>
            </table>
